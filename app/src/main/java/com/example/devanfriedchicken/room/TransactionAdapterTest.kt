...
class TransactionAdapterTest(var list: List<TransactionItems>, val viewModel: TransactionViewModel) :
    RecyclerView.Adapter<TransactionAdapterTest.TransactionViewHolder>() {

    // In this function we will add our transactionadaptertest.xml to kotlin class
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): TransactionViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.transactionadaptertest, parent, false)
